var LikeAG5;
(function (LikeAG5) {
    var MultidimensionalStorage = (function () {
        function MultidimensionalStorage() {
        }
        ...
        MultidimensionalStorage.__walker = function (path, o) {
        ...
        MultidimensionalStorage.setObj = function (key, value) {
            var path = key.split('.');
        ...
        MultidimensionalStorage.getObj = function (key) {
